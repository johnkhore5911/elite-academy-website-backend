...
const { getInfo, enrollAndCreateOrder,checkAccess,adminAddEnrollment,checkCrashCourseAccess,admincrashAddEnrollment,checkWeeklyAccess } = require("../controllers/coachingController");
